 ...
 return (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 md:px-8">
    <div className="max-w-3xl w-full bg-white rounded-2xl shadow-md border border-gray-200 p-8 relative">
      ...
      <form onSubmit={(e) => {  handleAddNote(e); }} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input
            id="title"
            type="text"
            className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-story-purple focus:border-story-purple"
